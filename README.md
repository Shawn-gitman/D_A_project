...
"Read-Speak_Korean_Webapp_Prediction(RSKWP)" is an web application focusing on web and prediction functionalities. If you want to predict scores based on Linear Regression, check out my latest repository in Github. Explanation video of RSKWP is in below and see results at https://www.readandspeak.ml/ 
